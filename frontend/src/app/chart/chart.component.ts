      ...
      .pipe(
        ...
        map<InvestmentResponse, any>(iv => {
          ...
          for (const record of results) {
            ...
            if (data.hasOwnProperty(record.ville)) {
              data[record.ville] = {
                montant_des_ap_votes_en_meu:
                  parseFloat(String(montant_des_ap_votes_en_meu)) +
                  parseFloat(data[record.ville].montant_des_ap_votes_en_meu),
                enveloppe_prev_en_meu:
                  parseFloat(String(enveloppe_prev_en_meu)) +
                  parseFloat(data[record.ville].enveloppe_prev_en_meu)
              };
            } else {
              data[record.ville] = {
                montant_des_ap_votes_en_meu: parseFloat(
                  String(montant_des_ap_votes_en_meu)
                ),
